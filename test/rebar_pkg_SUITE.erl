...
find_highest_matching(_Config) ->
    ...
    {ok, Vsn} = rebar_packages:find_highest_matching_(
                  <<"test">>, <<"1.0.0">>, <<"goodpkg">>, <<"1.0.0">>, #{name => <<"hexpm">>}, ?PACKAGE_TABLE, State),
    ?assertEqual(<<"1.0.1">>, Vsn),
    {ok, Vsn1} = rebar_packages:find_highest_matching(
                   <<"test">>, <<"1.0.0">>, <<"goodpkg">>, <<"1.0">>, #{name => <<"hexpm">>}, ?PACKAGE_TABLE, State),
    ?assertEqual(<<"1.1.1">>, Vsn1),
    {ok, Vsn2} = rebar_packages:find_highest_matching(
                   <<"test">>, <<"1.0.0">>, <<"goodpkg">>, <<"2.0">>, #{name => <<"hexpm">>}, ?PACKAGE_TABLE, State),
    ...
    ?assertEqual(none, rebar_packages:find_highest_matching_(<<"test">>, <<"1.0.0">>, <<"goodpkg">>,
                                                             <<"~> 5.0">>, #{name => <<"hexpm">>}, ?PACKAGE_TABLE, State)).
